...
// Defaults to false (demo stays off) until the document says otherwise, so
// login is required even before an admin ever visits the settings page and
// Firestore's "settings/security" doc doesn't exist yet.
