      ...
      <main className="mx-auto max-w-6xl space-y-8 px-4 py-10 sm:px-8">
        ...
        <div className="rounded-2xl border border-dashed border-border bg-surface p-6">
          ...
          <p className="mt-2 text-sm text-ink-soft">
            Modul Training dan sistem Invoice belum dibangun (butuh integrasi payment gateway
            terpisah) — akan ditambahkan setelah fitur tersebut ada. Manajemen Assessment,
            Webinar, Psikolog, dan Users di atas sudah nyambung ke data asli.
          </p>
        </div>
