        ...
        <div className="mx-auto max-w-6xl">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex shrink-0 items-center gap-4">
              ...
              <Link href="/super-admin/companies" className="hidden text-sm font-medium text-ink-soft hover:text-ink sm:inline">
                Companies
              </Link>
              <Link href="/super-admin/users" className="hidden text-sm font-medium text-ink-soft hover:text-ink sm:inline">
                Users
              </Link>
          ...
          <nav className="mt-4 flex items-center gap-4 overflow-x-auto sm:hidden">
            ...
            <Link href="/super-admin/companies" className="shrink-0 rounded-lg bg-surface-sunk px-3 py-1.5 text-xs font-medium text-ink">
              Companies
            </Link>
            <Link href="/super-admin/users" className="shrink-0 rounded-lg bg-surface-sunk px-3 py-1.5 text-xs font-medium text-ink">
              Users
            </Link>
      ...
      <main className="mx-auto max-w-6xl space-y-8 px-4 py-10 sm:px-8">
        ...
        <div className="rounded-2xl border border-border bg-surface p-6">
          ...
          <p className="mt-2 text-sm text-ink-soft">
            Kelola daftar perusahaan klien (kuota karyawan, kontak PIC, status kontrak) dan
            ubah role/perusahaan user mana pun di{" "}
            <Link href="/super-admin/companies" className="font-medium text-primary hover:underline">
              Companies
            </Link>{" "}
            dan{" "}
            <Link href="/super-admin/users" className="font-medium text-primary hover:underline">
              Users
            </Link>
            .
          </p>
          <p className="mt-3 text-xs text-ink-soft">
            Belum tersedia: sistem invoice/billing otomatis — ini butuh integrasi payment
            gateway terpisah dan sengaja belum dibangun di iterasi ini.
          </p>
        </div>
      </main>
    </div>
